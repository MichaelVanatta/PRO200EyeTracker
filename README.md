...
- Getting started
    ...
    - Now, load the extension as an unpacked extension (the option should appear after enabling developer mode), it should open a file dialogue box, point it to where you cloned/unzipped the extension under the source folder. (It has to be given the path where the `manifest.json` lives, or it won't load)
